...
const navItems = [
    ...
    { label: 'Pesanan', icon: FileText, href: '#', active: false },
    { label: 'Produksi', icon: Boxes, href: '#', active: false },
    { label: 'Produk', icon: Package, href: '#', active: false },
    { label: 'Tim', icon: Users, href: '#', active: false },
            ...
            <header class="dashboard-topbar">
                <div>
                    ...
                    ><span class="topbar-context"
                        >Workspace / <strong>Dashboard</strong></span
                    >
                </div>
